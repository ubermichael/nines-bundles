...
class DectivateUserCommandTest extends KernelTestCase {
    use FixturesTrait;
    ...
    public function testExecute() : void {
        ...
        $this->assertContains('Account user@example.com is not active.', $output);
    ...
    protected function setUp() : void {
        ...
        $command = $application->find('nines:deactivate:user');
