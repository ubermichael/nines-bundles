...
class DemoteUserCommandTest extends KernelTestCase {
    ...
    public function testExecute() : void {
        ...
        $this->assertContains('Role ROLE_ADMIN removed from admin@example.com.', $output);
    ...
    public function testExecuteAlreadyActive() : void {
        ...
        $output = $this->tester->getDisplay();
        $this->assertContains('Role ROLE_ADMIN removed from user@example.com.', $output);
    ...
    protected function setUp() : void {
        ...
        $command = $application->find('nines:demote:user');
