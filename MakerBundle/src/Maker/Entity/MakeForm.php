...
class MakeForm extends AbstractEntityMaker {
    ...
    public function generate(InputInterface $input, ConsoleStyle $io, Generator $generator) : void {
        ...
        $fixtures = $this->twig->render('@NinesMaker/form/form.php.twig', $details);
        $generator->dumpFile($details['form_class_path'], $fixtures);
