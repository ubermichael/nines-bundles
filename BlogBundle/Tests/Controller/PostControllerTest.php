...
class PostControllerTest extends BaseTestCase
{
    ...
    public function testAdminEdit() {
        $client = $this->makeClient(LoadUser::ADMIN);
        $formCrawler = $client->request('GET', '/post/1/edit');
        $this->assertEquals(200, $client->getResponse()->getStatusCode());
    ...
    public function testAdminNew() {
        $client = $this->makeClient(LoadUser::ADMIN);
        $formCrawler = $client->request('GET', '/post/new');
        $this->assertEquals(200, $client->getResponse()->getStatusCode());
    ...
    public function testAdminDelete() {
        $preCount = count($this->em->getRepository(Post::class)->findAll());
        $client = $this->makeClient(LoadUser::ADMIN);
        $crawler = $client->request('GET', '/post/1/delete');
        $this->assertEquals(302, $client->getResponse()->getStatusCode());
        $this->assertTrue($client->getResponse()->isRedirect());
        ...
        $this->em->clear();
        $postCount = count($this->em->getRepository(Post::class)->findAll());
